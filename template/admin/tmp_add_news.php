                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" name="title" value="<?php echo isset($news) ? $news['title'] : '';?>" class="form-control" placeholder="placeholder">
                                      </div>
                                  </div>
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" name="description" value="<?php echo isset($news) ? $news['description'] : '';?>" class="form-control" placeholder="placeholder">
                                      </div>
                                  </div>
